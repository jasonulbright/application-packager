...
.DESCRIPTION
    ...
    GetLatestVersionOnly queries the endoflife.date API for the latest 15.x release.
...
.PARAMETER FileServerPath
    ...
    Content is staged under: <FileServerPath>\Applications\PostgreSQL\PostgreSQL 15\<Version>

.PARAMETER DownloadRoot
    Local root folder for staging downloaded installers.
    Each packager creates a subfolder under this path (e.g., <DownloadRoot>\PostgreSQL15).
    Default: C:\temp\ap
