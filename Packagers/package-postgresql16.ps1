...
.DESCRIPTION
    Downloads the latest PostgreSQL 16.x EDB installer from the EnterpriseDB CDN,
    ...
    GetLatestVersionOnly queries the endoflife.date API for the latest 16.x release.
...
.PARAMETER FileServerPath
    ...
    Content is staged under: <FileServerPath>\Applications\PostgreSQL\PostgreSQL 16\<Version>

.PARAMETER DownloadRoot
    Local root folder for staging downloaded installers.
    Each packager creates a subfolder under this path (e.g., <DownloadRoot>\PostgreSQL16).
    Default: C:\temp\ap
...
.PARAMETER GetLatestVersionOnly
    Queries the endoflife.date API for the latest PostgreSQL 16.x version,
