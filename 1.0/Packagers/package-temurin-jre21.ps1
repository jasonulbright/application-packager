...
.DESCRIPTION
    Downloads the latest Eclipse Temurin JRE 21 x64 MSI, stages content to a
...
$AppFolder      = "Temurin JRE 21"
$Publisher      = "Eclipse Adoptium"
$AppNamePattern = "Eclipse Temurin JRE 21 - {0} (x64)"
$BaseDownloadRoot = Join-Path $DownloadRoot "TemurinJRE21"
...
function Invoke-StageTemurinJRE21 {
    Write-Log ""
    Write-Log ("=" * 60)
...
function Invoke-PackageTemurinJRE21 {
    Write-Log ""
    Write-Log ("=" * 60)
...
try {
    ...
    Write-Log ""
    Write-Log ("=" * 60)
    Write-Log "Eclipse Temurin JRE 21 (x64) Auto-Packager starting"
    Write-Log ("=" * 60)
    Write-Log ""
    ...
    if ($StageOnly) {
        Invoke-StageTemurinJRE21
    }
    elseif ($PackageOnly) {
        Invoke-PackageTemurinJRE21
    }
    else {
        Invoke-StageTemurinJRE21
        Invoke-PackageTemurinJRE21
