...
.DESCRIPTION
    Downloads the Visual Studio 2026 Enterprise bootstrapper, creates an offline
...
# VS 2026 bootstrapper (Stable channel, major version 18.x)
# See: https://learn.microsoft.com/en-us/visualstudio/install/create-a-network-installation-of-visual-studio
$BootstrapperUrl  = "https://aka.ms/vs/stable/vs_enterprise.exe"
$BootstrapperName = "vs_enterprise.exe"

$VendorFolder     = "Microsoft"
$AppFolder        = "Visual Studio 2026 Enterprise"
$BaseDownloadRoot = Join-Path $DownloadRoot "VS2026"

# Detection path - adjust year/edition if VS2026 uses a different install path
$DetectionPath = "{0}\Microsoft Visual Studio\2026\Enterprise\Common7\IDE" -f $env:ProgramFiles
...
function Invoke-StageVS2026 {
    Write-Log ""
    Write-Log ("=" * 60)
    Write-Log "Visual Studio 2026 Enterprise - STAGE phase"
    Write-Log ("=" * 60)
    Write-Log ""
    ...
    $appName   = "Visual Studio 2026 Enterprise - $version"
    $publisher = "Microsoft"
...
function Invoke-PackageVS2026 {
    Write-Log ""
    Write-Log ("=" * 60)
    Write-Log "Visual Studio 2026 Enterprise - PACKAGE phase"
    Write-Log ("=" * 60)
    Write-Log ""
...
try {
    ...
    Write-Log ""
    Write-Log ("=" * 60)
    Write-Log "Visual Studio 2026 Enterprise Auto-Packager starting"
    Write-Log ("=" * 60)
    Write-Log ""
