...
.DESCRIPTION
    Downloads the latest PostgreSQL 13.x EDB installer from the EnterpriseDB CDN,
    ...
    NOTE: PostgreSQL 13 reaches end-of-life on 2025-11-13. Consider migrating to
    a newer major version.

    GetLatestVersionOnly queries the endoflife.date API for the latest 13.x release.
...
.PARAMETER FileServerPath
    ...
    Content is staged under: <FileServerPath>\Applications\PostgreSQL\PostgreSQL 13\<Version>

.PARAMETER DownloadRoot
    Local root folder for staging downloaded installers.
    Each packager creates a subfolder under this path (e.g., <DownloadRoot>\PostgreSQL13).
    Default: C:\temp\ap
...
.PARAMETER GetLatestVersionOnly
    Queries the endoflife.date API for the latest PostgreSQL 13.x version,
