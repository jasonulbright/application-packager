...
## Supported Applications (83)

All 83 packagers are fully E2E validated (stage, install, detect, uninstall, removal verified). 33 previously included packagers were archived in v1.2.8 pending individual revalidation.
...
| Feature | Details |
|---|---|
| **Packager discovery** | Auto-discovers all 83 packager scripts via relative path |
...
application-packager/
  ...
  Packagers/
    ...
    package-7zip.ps1                 # One script per application (83 total)
    package-chrome.ps1
    ...
  Tests/
