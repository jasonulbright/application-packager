...
$toolTip.SetToolTip($grid,             "Select packagers using the checkboxes, then use the action buttons below")
$toolTip.SetToolTip($chkDebug,         "Show or hide the CMName and Script debug columns")
