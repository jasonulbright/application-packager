...
.PARAMETER DownloadRoot
    ...
    Each packager creates a subfolder under this path (e.g., <DownloadRoot>\ODBC18).
    Default: C:\temp\ap
...
$BaseDownloadRoot = Join-Path $DownloadRoot "ODBC18"
